...
import { USE_MOCK_DATA, mockOrders, mockMenuItems } from '@/utils/mock-data';
...
const SMART_NOTE_KEYWORDS: Record<string, { icon: string; color: string; bg: string }> = {
...
export function OrderManagement() {
  ...
  const fetchOrders = async () => {
    if (USE_MOCK_DATA) {
      setOrders(mockOrders as any[] as Order[]);
      setLoading(false);
      return;
    }
